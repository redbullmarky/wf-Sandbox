...
namespace wf::mesh
{
	Mesh createFullscreenQuad()
	{
		...
		mesh.vertices[0].position = Vec3{ -1.f, -1.f, 0.f };
		mesh.vertices[1].position = Vec3{ 1.f, -1.f, 0.f };
		mesh.vertices[2].position = Vec3{ 1.f, 1.f, 0.f };
		mesh.vertices[3].position = Vec3{ -1.f, 1.f, 0.f };
	...
	Mesh createCube(const Vec3& dimensions, const Colour& colour)
	{
		Mesh mesh;
	...
	Mesh createCubeExt(const Vec3& dimensions, const Colour& colour)
	{
		Mesh mesh;
